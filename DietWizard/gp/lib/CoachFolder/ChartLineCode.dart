...
class ChartLineDisplay extends StatefulWidget {
  final String baseUrl;
  final String name;
  final String email;

  const ChartLineDisplay({
    Key? key,
  ...
  @override
  _ChartLineDisplayState createState() => _ChartLineDisplayState();
}

class _ChartLineDisplayState extends State<ChartLineDisplay> {
...
child: Column(
  children: [
    ...
    color: Color.fromARGB(255, 240, 236, 236), // Color the container in grey
        ...
        SizedBox(height: 10,),
    SizedBox(
        height: 570, // Set the desired height
        child: ProgressPhotocoach(baseUrl: widget.baseUrl, name: widget.name, email: widget.email),
      ),
  ],
),
