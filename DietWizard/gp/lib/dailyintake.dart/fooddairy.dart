...
class fooddairy extends StatefulWidget {
  ...
  @override
  State<fooddairy> createState() => _fooddairyState();
}

class _fooddairyState extends State<fooddairy> {
        ...
        body: jsonEncode({
          'email': widget.email,
            'daydate': [   
              ...
              'remainingProgress':RemaningTotalCalories
        }),
        headers: {'Content-Type': 'application/json'},
      );
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            foodItems.removeAt(index); // Remove the item from the list
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          onPressed: () async{
                            ...
                            ExerciseItems.removeAt(index); // Remove the item from the list
...
Future<void> getcustomFood() async {
 ...
 //saveDiaryinfo()
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        icon: Icon(Icons.add),
                        onPressed: () {
                          _promptServingSize(context, customFood);//here to work inside that fn
                        },
                      ),
                    ],
                  ),
  ...
  if (int.tryParse(servingSize) != null) {
    ...
    double adjustmentRatio = int.parse(servingSize) / double.parse(customFood.size);

    // Calculate adjusted values
    int adjustedCalories = (double.parse(customFood.totCalories) * adjustmentRatio).round();
    String adjustedTotFat = (double.parse(customFood.totFat) * adjustmentRatio).toStringAsFixed(2);
    String adjustedSatFat = (double.parse(customFood.satFat) * adjustmentRatio).toStringAsFixed(2);
    String adjustedProtein = (double.parse(customFood.protein) * adjustmentRatio).toStringAsFixed(2);
    String adjustedSodium = (double.parse(customFood.sodium) * adjustmentRatio).toStringAsFixed(2);
    String adjustedPotassium = (double.parse(customFood.potassium) * adjustmentRatio).toStringAsFixed(2);
    String adjustedCholesterol = (double.parse(customFood.cholesterol) * adjustmentRatio).toStringAsFixed(2);
    String adjustedCarbs = (double.parse(customFood.carbs) * adjustmentRatio).toStringAsFixed(2);
    String adjustedFiber = (double.parse(customFood.fiber) * adjustmentRatio).toStringAsFixed(2);
    String adjustedSugar = (double.parse(customFood.sugar) * adjustmentRatio).toStringAsFixed(2);
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Invalid input. Please enter a valid integer.'),
      ),
    );
  }
},
...
Future<void> getcustomExe() async {
 ...
 //saveDiaryinfo()
  ...
  if (int.tryParse(duration) != null) {
    ...
    // Calculate the adjustment ratio based on the original size
    double adjustmentRatio = int.parse(duration) / double.parse(customExe.time);

    // Calculate adjusted values
    int adjustedCalories = (double.parse(customExe.totCalories) * adjustmentRatio).round();
                                                  ...
                                                  actions: <Widget>[
                                                    ...
                                                    TextButton(
                                                      onPressed: () async{
                                                       ...
                                                       String removeSuffix(String value) {
                                                        if (value.endsWith('g') && value != 'Calories') {
                                                        ...
                                                        return value;
                                                          ...
                                                          if (response.statusCode == 200) {
                                                            ...
                                                            if (dataList.isNotEmpty) {
                                                                    ...
                                                                    String nameofMeal = dataList[0]['name'];
                                                                     print("HereText1") ; 

                                                                    String calories = dataList[0]['calories'].toString();
                                                                    print("HereText2") ;

                                                                    String servingSizedb =  removeSuffix(dataList[0]['serving_size_g'].toString());
                                                                    print("HereText3") ;

                                                                    String totalFat = removeSuffix(dataList[0]['fat_total_g'].toString());
                                                                    print("HereText4") ;

                                                                    String saturatedFat = removeSuffix(dataList[0]['fat_saturated_g'].toString());
                                                                    print("HereText4") ;

                                                                    String protein = removeSuffix(dataList[0]['protein_g'].toString());
                                                                    print("HereText5") ;

                                                                    String sodium = removeSuffix(dataList[0]['sodium_mg'].toString());;
                                                                    print("HereText6") ;

                                                                    String potassium =  removeSuffix(dataList[0]['potassium_mg'].toString());
                                                                    print("HereText7") ;

                                                                    String cholesterol = removeSuffix(dataList[0]['cholesterol_mg'].toString());
                                                                    print("HereText8") ;

                                                                    String totalCarbohydrates = removeSuffix(dataList[0]['carbohydrates_total_g'].toString());
                                                                    print("HereText9") ;

                                                                    String fiber = removeSuffix(dataList[0]['fiber_g'].toString());
                                                                    print("HereText10") ;

                                                                    String sugar = removeSuffix(dataList[0]['sugar_g'].toString());
                                                                    print("HereText11") ;
                                                                                                                            // You can use the servingSize here
                                                              if (int.tryParse(servingSize) != null) {
                                                                print('Serving Size: $servingSize');
                                                                ...
                                                                // Calculate the adjustment ratio based on the original size
                                                                double adjustmentRatio = int.parse(servingSize) / double.parse(servingSizedb);

                                                                // Calculate adjusted values
                                                                int adjustedCalories = (double.parse(calories) * adjustmentRatio).round();
                                                                String adjustedTotFat = (double.parse(totalFat) * adjustmentRatio).toStringAsFixed(2);
                                                                String adjustedSatFat = (double.parse(saturatedFat) * adjustmentRatio).toStringAsFixed(2);
                                                                String adjustedProtein = (double.parse(protein) * adjustmentRatio).toStringAsFixed(2);
                                                                String adjustedSodium = (double.parse(sodium) * adjustmentRatio).toStringAsFixed(2);
                                                                String adjustedPotassium = (double.parse(potassium) * adjustmentRatio).toStringAsFixed(2);
                                                                String adjustedCholesterol = (double.parse(cholesterol) * adjustmentRatio).toStringAsFixed(2);
                                                                String adjustedCarbs = (double.parse(totalCarbohydrates) * adjustmentRatio).toStringAsFixed(2);
                                                                String adjustedFiber = (double.parse(fiber) * adjustmentRatio).toStringAsFixed(2);
                                                                String adjustedSugar = (double.parse(sugar) * adjustmentRatio).toStringAsFixed(2);
  ...
  Future<void> savecustomFood() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.of(context).pop();   // back here bahaa 
  ...
  void _saveItem() {
    ...
    if (isStringOnly(mealName)) {
      if (isNumeric(totalCalories) && isNumeric(servingSize)) {
        ...
        totalFatController.text = totalFatController.text.isEmpty ? '0' : totalFatController.text;
        saturatedFatController.text = saturatedFatController.text.isEmpty ? '0' : saturatedFatController.text;
        proteinController.text = proteinController.text.isEmpty ? '0' : proteinController.text;
        sodiumController.text = sodiumController.text.isEmpty ? '0' : sodiumController.text;
        potassiumController.text = potassiumController.text.isEmpty ? '0' : potassiumController.text;
        cholesterolController.text = cholesterolController.text.isEmpty ? '0' : cholesterolController.text;
        carbsController.text = carbsController.text.isEmpty ? '0' : carbsController.text;
        fiberController.text = fiberController.text.isEmpty ? '0' : fiberController.text;
        sugarController.text = sugarController.text.isEmpty ? '0' : sugarController.text;
...
class SingleExerciseListPage extends StatefulWidget {
  ...
  SingleExerciseListPage({Key? key, required this.baseUrl, required this.category, required this.email ,required this.name })
      : super(key: key);
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          ...
                                          AwesomeDialog(
                                            ...
                                            // width: nutritionalInfoWidgets.length * 500.0,
                                            title: 'Exercise Details',
                                            desc:"Name Exercise: "+ exercise.name +"\n"+"Time: "+ exercise.time +"\n"+"Calories: "+ exercise.calories +"\n"+"Description: "+ exercise.description,
                                            descTextStyle: TextStyle(fontSize: 18),
                                            btnCancelText: 'Close',
                                            btnCancelOnPress: () {},
                                          )..show();
                                        ...
                                        onPressed: () {
                                          // Add functionality here
                                              ...
                                              builder: (BuildContext context) {
                                                   String ExerciseTime = '';
                                                return AlertDialog(
                                                  title: Text('Enter Exercise Time'),
                                                  content: TextField(
                                                          onChanged: (value) {
                                                            ExerciseTime = value;
                                                    ...
                                                    TextButton(
                                                      onPressed: () async{
                                                        // Handle setting goal weight
                                                         ...
                                                         if (int.tryParse(ExerciseTime) != null) {
                                                                print('Exercise Time: $ExerciseTime');

                                                          String timeNumber = extractNumberFromString(exercise.time); 
                                                          String CaloriesNumber = extractNumberFromString(exercise.calories); 
                                                            ...
                                                            print(timeNumber);
                                                             print(CaloriesNumber);
                                                                 ...
                                                                 // Calculate the adjustment ratio based on the original size
                                                                double adjustmentRatio = int.parse(ExerciseTime) / double.parse(timeNumber);

                                                                // // Calculate adjusted values
                                                                 int adjustedCaloriesNumber = (double.parse(CaloriesNumber) * adjustmentRatio).round();
                                                                 String adjustedtimeNumber = (double.parse(timeNumber) * adjustmentRatio).toStringAsFixed(2);
                                                               
                                                               
                                                               // // Print adjusted values for debugging
                                                                 print('Adjusted CaloriesNumber: $adjustedCaloriesNumber');
                                                                 print('Adjusted timeNumber: $adjustedtimeNumber');
                                                                 print('Adjusted name: ${exercise.name}');
                                                                 print('Adjusted desc: ${exercise.description}');
                                                              

                                                              
                                                                  ExerciseItem newItem = ExerciseItem(
                                                                    ExerName: exercise.name,
                                                                    totCalories: adjustedCaloriesNumber,
                                                                    time: adjustedtimeNumber,
                                                                    disc: exercise.description,
...
String extractNumberFromString(String text) {
  ...
  if (match != null) {
    return match.group(0)!; // Use null assertion operator (!) to ensure non-null
  }
